...
-- =====================================================================
-- TABLE: transactions
-- Note: sender_id and receiver_id FKs omit ON DELETE/UPDATE actions
--       because MySQL 8.0.16+ forbids a column from being used in a
--       CHECK constraint when it is also part of an FK with referential
--       actions. Default RESTRICT behavior is desirable here: we never
--       want a user deletion to silently null out transaction parties.
-- =====================================================================
...
(6,  1, '2026-04-06 13:10:05'),
(6,  2, '2026-04-25 23:51:00'),
(10, 1, '2026-04-25 23:50:05'),
(10, 2, '2026-04-25 23:51:00'),
(10, 5, '2026-04-25 23:50:05'),
(9,  4, '2026-04-18 20:45:05'),
(4,  3, '2026-04-04 12:00:00'),
(1,  2, '2026-04-11 10:00:10'),
(7,  2, '2026-04-11 10:00:10'),
(8,  4, '2026-04-12 09:30:05'),
(3,  3, '2026-04-03 17:00:00');
...
-- Q1: All transactions with sender, receiver, category resolved
SELECT
    t.transaction_id,
    t.external_ref,
...
-- Q2: Total volume and transaction count per category
SELECT
    c.display_name         AS category,
    COUNT(*)               AS txn_count,
...
-- Q3: Transactions tagged BOTH high_value AND recurring (exercises M:N junction)
SELECT
    t.transaction_id,
    t.external_ref,
    t.amount,
...
-- Q7-Q10: CONSTRAINT TESTS (commented; uncomment one at a time to demo failures)

-- Q7: CASCADE delete demo
-- DELETE FROM tags WHERE tag_name = 'flagged';
-- SELECT * FROM transaction_tags;

-- Q8: Negative amount should fail CHECK
-- INSERT INTO transactions (external_ref, category_id, amount, transaction_date)
-- VALUES ('TXN_BAD_001', 1, -500.00, NOW());

-- Q9: Duplicate external_ref should fail UNIQUE
-- INSERT INTO transactions (external_ref, category_id, amount, transaction_date)
-- VALUES ('TXN20260401001', 1, 1000.00, NOW());

-- Q10: Self-transfer should fail CHECK
-- INSERT INTO transactions (external_ref, sender_id, receiver_id, category_id, amount, transaction_date)
-- VALUES ('TXN_SELF_001', 1, 1, 1, 500.00, NOW());